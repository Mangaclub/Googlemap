 ...
 * Gmap Controller
 */
class GmapControllergm_line_styles extends JControllerAdmin
{
	/**
	 * Proxy for getModel.
	 * @since	2.5
	 */
	public function getModel($name = 'gm_line_style', $prefix = 'GmapModel')
	{
	...
	public function line_style_delete()
		...
		$this->setRedirect( 'index.php?option=com_gmap&view=gm_line_styles' );
	}
}
?>